	...
	async showModal(languageId) {
		...
		contentDiv.innerHTML = `
			<div class="alert alert-info" role="alert">
				<p>This will copy selected content elements from <strong>${languageLabel}</strong> of this to another page.</p>
				<p class="mb-0">Please select the content elements to copy and provide the target page and language below.</p>
			</div>
